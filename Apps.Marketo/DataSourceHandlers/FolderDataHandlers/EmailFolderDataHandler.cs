...
{
    public class EmailFolderDataHandler : BaseInvocable, IAsyncDataSourceHandler
    {
        public EmailFolderDataHandler(InvocationContext invocationContext) : base(invocationContext)
        {
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            return response
                .DistinctBy(x => x.Id)
                .Where(x => x.FolderType == "Email" || x.Folder.Type == "Program")
